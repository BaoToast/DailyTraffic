...
目前版本：**v17.0（2026-08-14）**

本版同時支援原有雙向路段格式，以及 3～7 支線的路口轉向全日交通量格式。支援拖曳批次匯入、路段／路口自動切換明細表、各車種左轉／直行／右轉PCU係數，以及支線名稱、角度、轉向圖與人工修正。路口分析可切換「駛入路口／駛出路口」視角；駛出量依使用者確認的左轉、直行、右轉目的支線重新彙整，並同步套用到全日量、PCU、尖峰、車種組成、明細與 Excel 匯出。
